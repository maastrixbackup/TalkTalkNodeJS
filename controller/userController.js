...
const updateOrderStatus = async (req, res) => {
  try {
   ...
   const fetchAllOrdersSql = `SELECT id, access_casr, order_id, status FROM tbl_orders where status != "cancelled" and status != "rejected" and status != "failed" and status !="completed" LIMIT 50`;
